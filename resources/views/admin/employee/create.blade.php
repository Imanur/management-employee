                      ...
                      @csrf
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                              ...
                              <select class="custom-select @error('gender_id') is-invalid @enderror" name="gender_id" id="gender_id">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                              ...
                              <input type="text" class="custom-select datepicker @error('pob') is-invalid @enderror" name="dob" id="dob" placeholder="Birth Of Date"  autocomplete="off">
                              @error('dob')
                                <div class="invalid-feedback">
                                  {{ $message }}
                                </div>
                        ...
                        <div class="form-group row">
                          <div class="col-sm-6">
                              ...
                              <input type="text" class="form-control @error('position') is-invalid @enderror" name="position" id="position" placeholder="Job Title">
                              @error('position')
                                <div class="invalid-feedback">
                                  {{ $message }}
                                </div>
                          ...
                          <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control @error('division') is-invalid @enderror" name="division" id="division" placeholder="Division">
                            @error('division')
                              <div class="invalid-feedback">
                                {{ $message }}
                              </div>
                        ...
                        <div class="form-group row">
                          <div class="col-sm-6">  
                            <label for="religion_id">Religion</label>
                              <select class="custom-select @error('religion_id') is-invalid @enderror" name="religion_id" id="religion_id">
                            ...
                            <div class="col-sm-6">
                              <label for="image">Image</label>
                                <div class="input-group">
                                  ...
                                  <input class="form-control @error('image') is-invalid @enderror" type="file" name="image" id="image" onchange="previewImg()">
